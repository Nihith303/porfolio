...
function App() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitStatus({
        success: false,
        message: 'Failed to send message. Please try again later or email me directly at jonnalagaddanihith@gmail.com'
      });
    } finally {
  ...
  const projects = [
    ...
    },
    {
      ...
      githubLink: 'https://github.com/Nihith303/HandGesture-contolled-flappybird'
    },
    {
      ...
      githubLink: 'https://github.com/Nihith303/Brain-Detox'
    },
    {
      title: 'Grocery Match - Smart Shopping Assistant',
      period: 'Jan 2025 - Mar 2025',
      description: 'AI-powered grocery management platform with intelligent lists, price comparison across multiple stores, and personalized recommendations based on purchase history and dietary preferences.',
      technologies: ['React', 'Node.js', 'AI/ML', 'Price Comparison API', 'Recommendation Engine'],
      category: 'Web Development',
      highlights: ['Multi-store price comparison', 'AI recommendations', 'Dish generator', 'Inventory management'],
      githubLink: 'https://github.com/Nihith303/grocery-match'
    },
    {
      title: 'SEO Insights - AI SEO Automation Tool',
      period: 'Dec 2024',
      description: 'Comprehensive SEO analysis platform with AI-powered keyword relevance scoring, competitor gap analysis, and integration with premium LLMs for tailored SEO insights.',
      technologies: ['AI/ML', 'OpenAI', 'Claude', 'Gemini', 'Web Scraping', 'SEO APIs'],
      category: 'AI/ML',
      highlights: ['Keyword gap analysis', 'AI-generated alt text', 'Schema validation', 'Social media optimization'],
      githubLink: 'https://chromewebstore.google.com/detail/digispot-ai-seo-insights/njjbmbinhpipcdocojjniahjgdoljohg'
    },
    {
      ...
      githubLink: 'https://github.com/Nihith303/RAG-Chat-Assistant'
    },
    {
      ...
      githubLink: 'https://github.com/Nihith303/Webguru'
    },
    {
      ...
      githubLink: 'https://github.com/Nihith303/Interview-Ace'
    },
    {
      title: 'Handwritten Character Recognition',
      period: 'Sep 2025',
      description: 'Deep learning CNN model for recognizing handwritten digits and uppercase letters using Keras and TensorFlow. Features interactive drawing canvas for real-time character prediction.',
      technologies: ['TensorFlow', 'Keras', 'Scikit-learn', 'Tkinter', 'Matplotlib', 'Python'],
      category: 'AI/ML',
      highlights: ['36 character classes', 'Interactive canvas', 'Real-time prediction', 'CNN architecture'],
      githubLink: 'https://github.com/Nihith303/charater-recognition'
    },
    {
      ...
      githubLink: 'https://github.com/Nihith303/tic-tac-toe'
    },
    {
      ...
      githubLink: 'https://github.com/Nihith303/AI-Powered-Video-Summarizer'
    },
  ];
    ...
    <div className={`min-h-screen transition-colors duration-300`}>
      <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <div className="mb-8">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-6 text-gray-600 dark:text-gray-300 mb-8">
                  <div className="flex items-center">
                    <Mail className="w-5 h-5 mr-2" />
                    <span>jonnalagaddanihit@gmail.com</span>
                  </div>
                  <div className="flex items-center">
                    <Phone className="w-5 h-5 mr-2" />
                    <span>+91 9032682005</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <button 
                  ...
                  className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition-colors flex items-center"
                >
              ...
              <div className="flex justify-center space-x-4 pt-6">
                <a title="Github" href="https://github.com/Nihith303" target="_blank" rel="noopener noreferrer" 
                ...
                <a title="Linkedin" href="https://www.linkedin.com/in/jonnalagadda-nihit-918027284/" target="_blank" rel="noopener noreferrer"
                   className="p-3 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 rounded-full hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors">
                  <Linkedin className="w-6 h-6" />
                </a>
                <a title="LeetCode" href="https://leetcode.com/u/4ePe4tQrL1/" target="_blank" rel="noopener noreferrer"
                   className="p-3 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 rounded-full hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Full-Stack Developer & AI Innovator</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                    ...
                    Currently pursuing my B.Tech degree with an impressive 9.13 CGPA, I combine academic excellence with practical 
                    experience in building innovative solutions.
                  </p>
                  <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                    My journey spans from developing gamified learning platforms to creating AI-powered rehabilitation systems. 
                    I thrive on solving complex problems through technology and have demonstrated leadership in reviving student 
                    organizations and fostering vibrant tech communities.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">9.13</div>
                  ...
                  <div className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    ...
                    <div className="text-gray-600 dark:text-gray-300">IEEE Publication</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="mb-12">
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                    <div>
                      <h4 className="text-xl font-semibold text-gray-900 dark:text-white">SEO | Web Developer Intern</h4>
                      <p className="text-blue-600 dark:text-blue-400 font-medium">Digispot AI</p>
                    </div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-300 space-y-2">
                    <li className="flex items-start">
                      ...
                      Built a free Chrome extension “SEO Insights” that provides real-time keyword analysis, on-page SEO audits, and competitor insights for digital marketers.
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-blue-600 rounded-full mr-3 mt-2"></div>
                      Designed and implemented responsive, user-friendly web interfaces following agile methodologies.
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-blue-600 rounded-full mr-3 mt-2"></div>
                      Used Google Analytics, Search Console, and SEMrush to track KPIs and generate reports for stakeholders.
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-blue-600 rounded-full mr-3 mt-2"></div>
                      Conducted performance testing and debugging to enhance website speed, accessibility, and cross-browser compatibility.
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-blue-600 rounded-full mr-3 mt-2"></div>
                      Teamed with cross-functional members to design and deploy custom CMS solutions tailored for client needs.
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                      <div>
                        <h4 className="text-xl font-semibold text-gray-900 dark:text-white">Vice Chair</h4>
                        <p className="text-blue-600 dark:text-blue-400 font-medium">Computer Society of India (KARE)</p>
                      </div>
                      <div className="flex items-center text-gray-500 dark:text-gray-400 mt-2 md:mt-0">
                        <Calendar className="w-4 h-4 mr-2" />
                        Sep 2024 - Present
                    ...
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                      Revived and re-established the CSI student chapter after years of inactivity. Spearheaded membership drives, 
                      organized technical workshops, coding competitions, and guest lectures to foster a vibrant tech community.
                    </p>
                  </div>
                  ...
                  <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                      <div>
                        <h4 className="text-xl font-semibold text-gray-900 dark:text-white">Secretary</h4>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                      Managed all society operations, maintained communication among members and faculty, scheduled meetings, 
                      and handled documentation of events and initiatives for the Society.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-900 dark:text-white">B.Tech Computer Science & Engineering</h4>
                    <p className="text-blue-600 dark:text-blue-400">Kalasalingam Academy of Research and Education</p>
                    <p className="text-gray-500 dark:text-gray-400 text-sm">2026 | CGPA: 9.13</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-900 dark:text-white">Class XII</h4>
                    <p className="text-blue-600 dark:text-blue-400">Narayana Junior College</p>
                    <p className="text-gray-500 dark:text-gray-400 text-sm">2022 | 894/1000 Marks</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-900 dark:text-white">Class X</h4>
                    <p className="text-blue-600 dark:text-blue-400">Dr.Kishore Ratnam High School</p>
                    <p className="text-gray-500 dark:text-gray-400 text-sm">2020 | 544/600 Marks</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                    An AI-Powered Framework for Real-Time YouTube Video Transcript Extraction and Summarization using Google Gemini
                  </h4>
                  <p className="text-blue-600 dark:text-blue-400 font-medium mb-2">IEEE Publication</p>
                  <p className="text-gray-500 dark:text-gray-400 text-sm mb-3">Published: January 17, 2025</p>
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                    Research paper on AI-powered framework for automated video transcription and summarization, 
                    addressing the need for efficient content consumption in the digital age.
                  </p>
                  <a 
                    href="https://ieeexplore.ieee.org/document/10841652" 
                    target="_blank" 
                    rel="noopener noreferrer"
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-600 dark:text-gray-300">jonnalagaddanihit@gmail.com</span>
                  </div>
                  <div className="flex items-center">
                    <Phone className="w-5 h-5 text-blue-600 mr-4" />
                    <span className="text-gray-600 dark:text-gray-300">+91 9032682005</span>
                  </div>
                  <div className="flex items-center">
        ...
        <footer className="bg-gray-900 dark:bg-black text-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h3 className="text-2xl font-bold mb-4">Nihit Jonnalagadda</h3>
              ...
              <div className="flex justify-center space-x-6 mb-8">
                ...
                <a title="Email" href="mailto:jonnalagaddanihit@gmail.com"
                   className="text-gray-400 hover:text-white transition-colors">
              ...
              <div className="border-t border-gray-800 pt-8">
                <p className="text-gray-400 text-sm">
                  © 2025 Nihit Jonnalagadda. All rights reserved. Built with React & Tailwind CSS.
                </p>
              </div>
            </div>
          </div>
